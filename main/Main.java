...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (PCB p : jobQueue) p.printProcess();
        ...
        Thread schedulerThread = new Thread(() -> scheduler.run(choice));
        
        int totalMemory = 2048;
        LoaderThread loader = new LoaderThread(jobQueue, readyQueue, totalMemory, schedulerThread);
        ...
        for (PCB p : readyQueue) p.printProcess();
